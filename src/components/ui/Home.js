...
const CombinedComponent = () => {
    ...
    if (showHome) {
        return (
            <div className="flex flex-col min-h-[100dvh] text-gray-300">
                <header className="py-4 px-4 md:px-6 min-h-20 bg-[#121212]">
                    <motion.div
                        ...
                        <div className="bg-gray-300 text-[#121212] inline-block rounded-lg shadow-md">
                            <motion.div
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                                transition={{ duration: 2 }}>
                ...
                <main className="flex-1">
                    <section className="bg-[#121212f3] py-12 md:py-24 lg:py-32 min-h-[calc(100svh-5rem)]">
                        <motion.div
                    ...
                    <section className="py-12 md:py-24 lg:py-32 bg-[#121212]">
                        <motion.div
                            ref={mainRef}
                ...
                <footer className="bg-[#121212f3] py-8">
